  ...
  return (
    <section className="bg-white">
      <div className="max-w-[1200px] my-0 mx-auto p-6 md:py-10 md:px-10">
        <div className="flex flex-col-reverse gap-0 md:gap-10 border border-[#EBEBEB] rounded-[40px] md:flex-row">
        ...
        <div className="flex flex-col gap-6 my-7  md:gap-4 md:flex-row">
          <div className="w-full p-6 md:w-1/2 md:p-10 xl:pt-14 xl:px-10 border border-[#EBEBEB] rounded-[40px]">
        ...
        <div className="flex flex-col-reverse gap-0 md:gap-6 items-center border border-[#EBEBEB] rounded-[40px] md:flex-row">
